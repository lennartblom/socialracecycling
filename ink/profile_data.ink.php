...
while($dsatz = mysql_fetch_assoc($sql)){
 ...
 <div class=\"activities-top\"></div>
            ...
            ".DatumsWandler($dsatz["date"])." | von ".$_SESSION['Vorname']." ".$_SESSION['Nachname']."</span>\n
            ...
            <span style=\"font-weight:bold;\">Distanz:</span> ".$dsatz["distance"]."  \n
...
Du hast noch keine Aktivitäten hochgeladen. <a href=\"add-tour.php\">Trage</a> doch deine erste Aktivität ein! <br />
...
$tpl->assign('charts_yearelevation', $row['charts_elevation_year']);
