...
<h5 style="text-align:left;"><!--<img src="images/profile/arrow-left-24.png" height="15px" />--> <img src="images/profile/user-icon.png" /> <span style="font-weight:300;">Profil von</span> {$name} {$lastname}</h5>
