...
<table style="margin-left:45px;">
        ...
        <table>
            <tr>
                ...
                <td><input readonly name="profile_name"  class="addtour-normalinput"  value="{$name}" /></td>
            </tr>
            <tr>
                <td class="profil-column">Nachname:</td>
                <td><input  readonly name="profile_lastname"  class="addtour-normalinput"  value="{$lastname}" /></td>
            </tr>
            <tr>
