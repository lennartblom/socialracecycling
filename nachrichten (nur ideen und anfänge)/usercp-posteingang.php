...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <title>Posteingang | Social Race Cycling</title>
...
error_reporting(E_ALL & ~E_DEPRECATED);
	...
	if(isset($_SESSION['UserID'])){
		...
		echo	"					<li><a href=\"usercp-posteingang.php\" class=\"usercp-navigation-button-active\">Posteingang</a></li>\n";
		...
		echo	"			<table border=\"1\" id=\"edittour-tabelle\">\n
								<tr>\n
									...
									<td class=\"edittour-showtour-headline\">empfangen</td>\n
								</tr>\n";
		echo	"				 ".ListMessagesInBox()."\n";
		echo	"			</table>\n";
		echo	"				</p>\n";
        echo	"   		</div>";
		echo	"		</div>\n";
