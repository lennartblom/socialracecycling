...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <title>Postausgang | Social Race Cycling</title>
...
error_reporting(E_ALL & ~E_DEPRECATED);
	...
	if(isset($_SESSION['UserID'])){
		...
		echo	"					<li><a href=\"usercp-create_pm.php\" class=\"usercp-navigation-button\">Nachricht erstellen</a></li>\n";
		echo	"					<li><a href=\"usercp-posteingang.php\" class=\"usercp-navigation-button\">Posteingang</a></li>\n";
		echo	"					<li><a href=\"usercp-postausgang.php\" class=\"usercp-navigation-button-active\">Postausgang</a></li>\n";
		echo	"			</ul>\n";
		echo	"			</ul>\n";
		echo	"		</div>\n";
		...
		echo	"			<table border=\"1\" id=\"edittour-tabelle\">\n
								<tr>\n
									<td class=\"edittour-showtour-headline\">Auswahl</td>\n
									<td class=\"edittour-showtour-headline\">Betreff</td>\n
									<td class=\"edittour-showtour-headline\">Absender</td>\n
									<td class=\"edittour-showtour-headline\">Empfänger</td>\n
									<td class=\"edittour-showtour-headline\">gesendet</td>\n
								</tr>\n";
		echo	"				 ".ListMessagesOutBox()."\n";
		echo	"			</table>\n";		
		echo	"				</p>\n";
        echo	"   		</div>";
		echo	"		</div>\n";
